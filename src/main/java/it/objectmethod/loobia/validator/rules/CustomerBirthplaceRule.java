...
public class CustomerBirthplaceRule implements IValidatorRule {
	...
	public void validate(Map<String, Object> paramsToValidate) {
		...
		MunicipalityRepository municRepo = (MunicipalityRepository) paramsToValidate.get("municRepo");
		Municipality municipality = municRepo.findByNome(customer.getComuneNascita());
